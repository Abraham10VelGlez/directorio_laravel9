  $(document).ready(function(){
   ...
   $('li.classsd').click(function (event){
       ...
       $.ajax({ url: "dashboard/avgrenderigecem",type: "POST",dataType: "JSON",data: {xx:clavemunic},beforeSend: function () {
		 	//$("#load2").css('display','block');
		 	 },timeout:20000,}).done(function(w) {$(w).each(function(key,valuee){
        ...
        }).fail(function(jqXHR,textStatus,errorThrown) {/*console.log(textStatus);*/}) .always(function(r) {/*console.log(r);*/});



        $.ajax({ url: "dashboard/avgrenderigecem2",type: "POST",dataType: "JSON",data: {xx:clavemunic},beforeSend: function () {
       //$("#load2").css('display','block');
        },timeout:20000,}).done(function(w) {
   ...
   /*set code for Ing abraham date 14-02-2020*/
         ...
         $.ajax({ url: "dashboard/avgrenderigecem3",type: "POST",dataType: "JSON",data: {xx:clavemunic},beforeSend: function () {
        //$("#load2").css('display','block');
         },timeout:20000,}).done(function(w) {
           $(w).each(function(key,valuee){
    ...
    /*set code for Ing abraham date 14-02-2020*/
          ...
          $.ajax({ url: "dashboard/avgrenderigecem4",type: "POST",dataType: "JSON",data: {xx:clavemunic},beforeSend: function () {
         //$("#load2").css('display','block');
          },timeout:20000,}).done(function(w) {
            $(w).each(function(key,valuee){
     ...
     /*set code for Ing abraham date 14-02-2020*/
           ...
           $.ajax({ url: "dashboard/avgrenderigecem5",type: "POST",dataType: "JSON",data: {xx:clavemunic},beforeSend: function () {
          //$("#load2").css('display','block');
           },timeout:20000,}).done(function(w) {
             $(w).each(function(key,valuee){
